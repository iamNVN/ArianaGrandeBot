...
PM_START_TEXT = """
Hey there! My name is Ariana Grande - I'm here to help you manage your groups!

Click Help button to find out more about how to use me to my full potential.

Join My Support Group [Ariana Grande Bot Support](http://t.me/ArianaGrandeSupport) if you need any support or help.

Don't Forget To CheckOut [My Owner](http://t.me/NinjaNaveen) 

Want to add me to your group? Click here! [Click Here](http://t.me/ArianaGrandeGMBot?startgroup=true)
"""

HELP_STRINGS = """
Hello! I'm Ariana Grande
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("Hey, I'm Ariana Grande. PM me if you have any questions on how to use me!")
